...
const NIGHTLY_URL = "https://github.com/neovim/neovim/releases/download/nightly/nvim-linux-x86_64.tar.gz";
const STABLE_URL = "https://github.com/neovim/neovim/releases/latest/download/nvim-linux-x86_64.tar.gz";
  ...
  try {
    ...
    switch (nvimVersion) {
      ...
      case "stable":
        ...
        break;
      default:
        console.error(`Invalid nvim version: ${nvimVersion}. Use 'stable' or 'nightly'`);
        process.exit(1);
    }

    // Download nvim
    execCommand('wget', ['-q', downloadUrl, '-O', NVIM_TAR]);

    // Extract and link nvim binary
    execCommand('tar', ['xzf', NVIM_TAR, '-C', NVIM_DIR]);
    try {
